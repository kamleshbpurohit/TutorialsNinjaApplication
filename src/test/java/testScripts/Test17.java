...
public class Test17 extends BaseClass
{
	@Test
	public void tc_ac_002()
	{
		...
		register.sendNewUserInfo(map.get("First Name"), "", map.get("Email"), map.get("Telephone"), map.get("Password"), map.get("Password confirm"));
